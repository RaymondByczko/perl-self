...
# at an outer file scope can be seen in called subroutines, and seen
# in subroutines called by that one.
# @observation x is seen from top down through call stack.
use strict;
my $x = 99;
sub get_smart {

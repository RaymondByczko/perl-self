...
my $brefFavColor = bless $refFavColor; # Now brefFavColor should be its own object
					# and not have any connection to favColor.

print "COLOR AFTER (after bless)", "\n";
print "favColor is: ", $favColor, "\n";
print "refFavColor is(double dollar): ", $$refFavColor, "\n";
print "refFavColor is(single dollar): ", $refFavColor, "\n";
print "brefFavColor is:", $brefFavColor, "\n";
print "brefFavColor is (double dollar):", $$brefFavColor, "\n";

$brefFavColor = "purplered";

print "COLOR AFTER CHANGE(after bless)", "\n";
print "favColor is: ", $favColor, "\n";
print "refFavColor is(double dollar): ", $$refFavColor, "\n";
print "refFavColor is(single dollar): ", $refFavColor, "\n";
print "brefFavColor is:", $brefFavColor, "\n";
